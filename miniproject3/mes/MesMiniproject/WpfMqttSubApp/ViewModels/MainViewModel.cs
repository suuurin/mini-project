...
namespace WpfMqttSubApp.ViewModels
{
    public partial class MainViewModel : ObservableObject, IDisposable
    {
        ...
        public MainViewModel(IDialogCoordinator coordinator)
        {
            ...
            BrokerHost = App.Configuration.Mqtt.Broker; // "210.119.12.69";
            DatabaseHost = App.Configuration.Database.Server; // "210.119.12.69";
            mqttTopic = App.Configuration.Mqtt.Topic; //"pknu/sf69/data";   // 설정파일로 작업가능
        ...
        private async Task ConnectMqttBroker()
        {
            ...
            mqttClient.ConnectedAsync += async e =>
            {
                ...
                // 연결 이후 구독(Subscribe)
                await mqttClient.SubscribeAsync("pknu/sf69/data");
            };
            // MQTT 구독메시지 로그출력
            mqttClient.ApplicationMessageReceivedAsync += e =>
            {
                ...
                // json데이터를 일반객체로 다시변환 -> 역직렬화(Deserialization)
